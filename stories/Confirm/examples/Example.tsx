...
/**
 * Типовой сценарий: закрытие LightBox с несохранёнными данными подтверждается
 * предупреждением в верхней панели.
 */
                    ...
                    <LightBox.Content isLoading={false}>
                        ...
                        <TopOverlay opened={topOverlayOpened} onOpen={() => {}} onClose={() => {}}>
                            <Confirm>
                                ...
                                <Confirm.Close
                                    title="Закрыть"
                                    // Закрыть по Esc, только пока верхняя панель открыта.
