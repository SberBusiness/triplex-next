...
describe("ModalWindowBody", () => {
    ...
    it("does not expose Island loading props in its public type", () => {
        // @ts-expect-error loading исключён из IModalWindowBodyProps через Omit.
        const withLoading: IModalWindowBodyProps = { loading: true };
        ...
        expect([withLoading, withLoaderScreenProps]).toHaveLength(2);
    });
