...
5. **Что осталось пользователю** — обновить `{Name}-ai.md`, написать release notes (нужны всегда: изменение публичного API или поведения — по существу, чистый рефакторинг — одной строкой), коммит.
