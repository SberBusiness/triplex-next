...
| `borderRadius`                | `EAlertProcessBorderRadius` | `EAlertProcessBorderRadius.MD` | Скругление углов: `MD` (16px) / `LG` (24px)                                                                           |
...
(16px / 24px) и внутренние отступы (16px) заданы литералами в
...
| 2026-08-28 | Скругление варианта `MD` увеличено с 12px до 16px в `styles/AlertProcess.module.less`. |
