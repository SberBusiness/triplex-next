...
- Исключение — **adaptiveMode**: он виден в таблице props, потому что приходит из **ICalendarProps**, но компонент вычисляет его сам (десктопное меню — false, мобильное — true) и переданное значение игнорирует.
                `,
            },
            page: () => (
                <>
