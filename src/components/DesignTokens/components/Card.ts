...
export const Card_Tokens: TDesignTokensComponentsCardValues = {
    ...
    Action_Secondary_Background: [{ ref: "ColorNeutral.90" }, { ref: "ColorDarkNeutral.80" }], // var(--triplex-next-Card-Action_Secondary_Background)
    ...
    Action_Secondary_Background_Selected: [{ ref: "ColorNeutral.40" }, { ref: "ColorDarkNeutral.100" }], // var(--triplex-next-Card-Action_Secondary_Background_Selected)
    ...
    Shadow_Default: [{ value: "0 0 7px 0 rgba(31, 31, 34, 0.25)" }, { value: "none" }], // var(--triplex-next-Card-Shadow_Default)
    Shadow_Hover: [{ value: "0 0 14px 0 rgba(31, 31, 34, 0.25)" }, { value: "none" }], // var(--triplex-next-Card-Shadow_Hover)
};
