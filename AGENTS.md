...
| `.agents/skills/release-auto/SKILL.md` | Preflight checks and unattended release from the weekly routine; no `prerelease-1.Y.0` marker branch means no release |
