 ...
 * Стрелки видны только при ховере на крупной картинке, поэтому без интеракции
 * на скриншоте их нет; этим тест фиксирует, что стрелки не показываются без
 * ховера. Слева — первое изображение (стрелка «назад» disabled и потому скрыта
 * вовсе), справа — последнее (стрелка «вперёд» disabled, плюс блюр-слой по краям).
 */
