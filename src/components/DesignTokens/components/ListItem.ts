...
export const ListItem_Tokens: TDesignTokensComponentsListItemValues = {
    ...
    Background_Dragging: [{ ref: "ColorNeutral.100" }, { ref: "ColorDarkNeutral.10" }], // var(--triplex-next-ListItem-Background_Dragging)
    Background_Selected: [{ ref: "ColorNeutral.90" }, { ref: "ColorDarkNeutral.60" }], // var(--triplex-next-ListItem-Background_Selected)
    Background_Hover: [{ ref: "ColorNeutral.90" }, { ref: "ColorDarkNeutral.50" }], // var(--triplex-next-ListItem-Background_Hover)
    BorderColor_Focus: [{ ref: "ColorWarning.80" }, { ref: "ColorWarning.80" }], // var(--triplex-next-ListItem-BorderColor_Focus)
