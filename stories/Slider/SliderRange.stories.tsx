...
Значения контролируемые: компонент сообщает новую пару через **onChange** и ждёт её в **values** — без обновления **values** снаружи ползунки не двигаются. Наружу пара всегда уходит отсортированной, даже если ползунки поменялись местами.
...
export const Disabled: StoryObj<typeof SliderRange> = {
    ...
    parameters: {
        controls: { disable: true },
        docs: {
            description: { story: "Неактивный слайдер: ползунки, трек и метки не реагируют на курсор и клавиатуру." },
            source: {
                code: DisabledSource,
                language: "tsx",
            },
