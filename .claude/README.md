...
- В unattended публикация невозможна (прокси облачных сессий запрещает все
...
- До первого коммита зондирует режим публикации: право на диспатч есть →
  полный релиз; 403 (штатно для облака) → прогон только готовит `0.Y.0`,
  публикацию завершает человек по командам из отчёта.
