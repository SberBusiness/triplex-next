...
import { UnorderedListExtended } from "@sberbusiness/triplex-next/components/UnorderedListExtended/UnorderedListExtended";
...
describe("UnorderedListExtended", () => {
    ...
    it("renders list item with custom compound Marker component", () => {
        render(
            <UnorderedListExtended>
        ...
        const marker = screen.getByTestId("extended-marker");
