...
|---|---|---|---|
| `sticky` | `boolean` | `false` | Заголовок прилипает к верхней границе при скролле, если высота viewport больше 800px. **Только для `type=FIRST`** (внутри `LightBox`); для `type=SECOND` типизирован как `never`. |
...
| Дата | Изменение |
|---|---|
| 2026-08-06 | Sticky-позиционирование отключено при высоте viewport не больше 800px. |
