...
export const KeyboardNavigation: Story = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                story: "Перемещение активной ноды стрелками вверх/вниз. Активной нода становится по фокусу, дальше стрелки двигают `activeNode` по дереву и спускаются только в раскрытые ветки. Обход циклический: `ArrowUp` с первой ноды переходит на последнюю видимую ноду дерева. Подсветку активной ноды рисует потребитель по provide-prop `activeNode`.",
            },
